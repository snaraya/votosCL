#' Candidaturas a alcalde en elecciones municipales 2004 en Chile
#'
#' Base de datos de candidaturas a alcalde para las elecciones
#' municipales chilenas de 2004, construida a partir de datos
#' oficiales del Servicio Electoral de Chile (SERVEL).
#'
#' @format Una base de datos con 1.933 filas y 16 columnas.
#' \describe{
...
#'
#' @examples
#' head(alcaldes_2004_candidatos)
#'
"alcaldes_2004_candidatos"
